...
/// Error type returned when trying to convert from an underlying repr that is not one of the
/// known variants, generated by the [`TryFromKnownRepr`] derive macro.
